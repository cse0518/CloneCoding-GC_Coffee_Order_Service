...
import static com.clonecoding.gccoffee.util.JdbcUtils.toLocalDateTime;
import static com.clonecoding.gccoffee.util.JdbcUtils.toUUID;
...
public class ProductJdbcRepository implements ProductRepository {
    ...
    public ProductJdbcRepository(final NamedParameterJdbcTemplate jdbcTemplate) {
    ...
    public Product insert(final Product product) {
        final var update = jdbcTemplate.update("INSERT INTO products(product_id, product_name, category, price, description, created_at, updated_at)" +
    ...
    @Override
    public Optional<Product> findByName(final String productName) {
        try {
            return Optional.ofNullable(
    ...
    private Map<String, Object> toParamMap(final Product product) {
